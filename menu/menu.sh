...
Isadmin=$(curl -sS https://raw.githubusercontent.com/annelyah23/permission/main/access | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/annelyah23/permission/main/access | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/annelyah23/snip/main/plugins/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/annelyah23/snip/main/plugins/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/annelyah23/snip/main/plugins/versi)
if [ "$Isadmin" = "ON" ]; then
...
echo -e "  ${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${WH}XTLS   ${WH}[${COLOR1}ON${WH}]   ${WH}[${COLOR1}11${WH}]${NC} ${COLOR1}• ${WH}SETTINGS ${WH}[${COLOR1}Menu${WH}]  $COLOR1 $NC"
