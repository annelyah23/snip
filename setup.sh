...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/annelyah23/permission/main/access > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/annelyah23/permission/main/access | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/annelyah23/permission/main/access | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
sleep 2
clear
wget https://raw.githubusercontent.com/annelyah23/snip/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/annelyah23/snip/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/annelyah23/snip/main/xtls/xtls.sh && chmod +x xtls.sh && ./xtls.sh
#Set Backup
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/annelyah23/snip/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/annelyah23/snip/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
#Install SSH Websocket
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/annelyah23/snip/main/openvpn/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#Download Extra Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
echo -e "${tyblue}|           DOWNLOAD EXTRA MENU            |${NC}"
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/annelyah23/snip/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/annelyah23/snip/main/version  )
...
echo ""  | tee -a log-install.txt
echo "    [INFORMASI  Squid Proxy, Bdvp, Ngnx]" | tee -a log-install.txt
echo "    ---------------------------" | tee -a log-install.txt
...
echo "   - Xray Trojan Ws None Tls   : (Coming Soon)"  | tee -a log-install.txt
echo "   --------------------------------------------------------------" | tee -a log-install.txt
